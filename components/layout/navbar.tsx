  ...
  return (
    <nav className="h-80 bg-secondary z-10 flex px-15 sticky text-white filter drop-shadow-lg">
      <div className="container px-0 mx-auto flex justify-between xl:justify-start">
        <Link href="/"><a className="flex items-center"><Image src="/assets/images/logo.svg" height={38} width={130} alt="Skatin logo" /></a></Link>
        ...
        <div className={
          ...
          <ul className="flex flex-col xl:flex-row font-medium text-16 xl:text-14 pl-30 xl:pl-0">
            <li className="py-15 nav-link"><Link href="/stake"><a className="relative xl:px-25 xl:py-10">Stake</a></Link></li>
            <li className="py-15 nav-link"><Link href="/lottery"><a className="relative xl:px-25 xl:py-10">Lottery</a></Link></li>
            <li className="py-15 nav-link"><Link href="/finance"><a className="relative xl:px-25 xl:py-10">Finance</a></Link></li>
            <li className="py-15 nav-link"><Link href="/blog"><a className="relative xl:px-25 xl:py-10">Blog</a></Link></li>
            {navbarOpen && <li className="py-15 nav-link"><Link href="/login"><a className="relative xl:px-25 xl:py-10">Login</a></Link></li>}
            {navbarOpen && <li className="py-15 nav-link"><Link href="/signup"><a className="relative xl:px-25 xl:py-10">SignUp</a></Link></li>}
          </ul>
          <div className="hidden xl:block flex items-center px-5">
            <Link href="/login" passHref><button className="btn-warning btn-mini mr-10">Login</button></Link>
            <Link href="/signup" passHref><button className="btn-primary btn-mini">SignUp</button></Link>
          </div>
        </div>
      </div>
    </nav>
