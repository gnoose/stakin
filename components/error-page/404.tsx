  ...
  return (<section className="w-screen h-screen">
    <div className="container mx-auto flex flex-col justify-center items-center h-full">
      <div className="py-30 md:py-40">
        <Link href="/" passHref><Image className="cursor-pointer" src="/assets/images/logo-green.svg" width={250} height={71} alt="Stakin logo" /></Link>
      </div>
      <div className="py-0 md:py-30 xl:py-50">
        ...
        <div className="flex flex-col md:flex-row justify-center mt-30 md:mt-60 w-full">
          ...
          <Link href="/login" passHref><button className="btn btn-warning btn-lg md:ml-20 w-full md:w-220">Please login to the website</button></Link>
        </div>
      </div>
      <p className="text-16 text-light-500 mt-30 md:mt-40 xl:mt-60 text-center">
        You can still contact us via <a className="text-primary" href="https://www.instagram.com/stakin">Instagram</a>, by email at <a className="text-primary" href="mailto:jieli@stakin.com">jieli@stakin.com</a> or by phone at <a href="tel:13862691692" className="text-primary">1 386 269 1692</a>.
      </p>
